...
By contributing, you agree to the [Percona Community code of conduct](https://percona.community/contribute/coc/). Thank you helping us enhance Percona Server for MySQL.

## Why Your Contribution Matters?

Main driving force of open source project is community. We, as developers team, highly appreciate all contributions.

It may be advisable to initially submit bug fixes to the upstream project that will eventually become part of next release of Percona. Alternatively, Percona provides expedited response times, transparent development processes, and streamlined contribution acceptance within a public repository.
...
To create Jira issue, please open the  [ LINK ](https://perconadev.atlassian.net/jira/software/c/projects/PS/issues) and authenticate with your favorite social network account (Google, Facebook, etc). Then follow the instructions and verify your e-mail. If Jira starts to redirect you back and forth (their bug, not ours), just open new browser window with the link above.

Now you're ready to create issue. Find the big "Create" button in the top menu and press it. Choose issue type from the second drop-down, saying it is Bug, Improvement, or a New feature. Fill all required fields below. Don't spare the letters for the description field. Accurate and detailed description is a huge first step to the solution. Rest of fields are mostly for internal use, the core team developers will fill it later.
...
If it is bug fix, make sure that corresponding tests from the test suite work fine. It's a good idea to patch existing test to cover your specific case. For the introduction of new features, the development of a comprehensive test suite is strongly recommended.

## Preparing the PR

After finishing the tasks outlined above, you have to prepare your branch for a pull request.   
...
For example, the fix of bug should have just one commit. If you have a new feature that requires some changes to the existing code, then first commit should contain required changes, and the second should have the new feature and test suite. It is not a dogma, on the other hand, we value a clean and consistent Git history. Please help us maintain this standard.
...
Following this step, the development team will conduct a thorough review of your code in their earliest convenience. Our primary objective is to ensure the highest quality standards. We encourage you to interpret our comments as opportunities for improvement and constructive feedback.

When the review is finished and all the issues are addressed, your pull request will be merged into the main source tree.

Congratulation! You are now a recognized contributor.
